...
{
    public float winTemperature = 405f;   // целевая температура
    public float winTolerance = 10f;     // «рядом» = ±5 K
    ...
    void Update()
    {
        ...
        {
 //           cycleCoroutine = StartCoroutine(RunIsochoricCycle());
        }
